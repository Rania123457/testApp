...
class ConsultsancePost extends StatelessWidget {
  ...
  ConsultsancePost({super.key, required index, required list});
  @override
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            onPressed: () {
                              databaseHelper.addConsul(
                                commentController.text,
                                commentTitleController.text,
                                imageController.toString(),
                                recordController.toString(),
                              );
                              if (databaseHelper.status) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text("لم تتم اضافة المنشور'"),
                                  ),
                                );
                              } else {
